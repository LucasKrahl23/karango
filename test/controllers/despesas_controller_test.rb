...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { descricao: @despesa.descricao, despesa_dt: @despesa.despesa_dt, formaspagamento_id: @despesa.formaspagamento_id, obs: @despesa.obs, valor: @despesa.valor, veiculo_id: @despesa.veiculo_id } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { descricao: @despesa.descricao, despesa_dt: @despesa.despesa_dt, formaspagamento_id: @despesa.formaspagamento_id, obs: @despesa.obs, valor: @despesa.valor, veiculo_id: @despesa.veiculo_id } }
